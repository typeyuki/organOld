<#--&lt;#&ndash;<img src="/static/img/map/gumei_9.jpg" id="ditu">&ndash;&gt;-->
<#--<style type="text/css">-->
...
<#--<div class="col-lg-15" style="width:1000px;height:1000px;border:#ccc solid 1px;" id="dituContent" align="center"></div>-->
    <#--<script type="text/javascript">-->
        ...
        <#--function createMap(){-->
            ...
            <#--//var point = new BMap.Point(121.404295,31.151234);//定义一个中心点坐标-->
             <#--var point=new BMap.Point(121.398834,31.151419);-->
    ...
    <#--</script>-->
<#--heatmap-->
    <#--<div id="container" style="display: none;width:600px;height:400px;border:#ccc solid 1px;" class="col-lg-15" ></div>-->
    <#--<script type="text/javascript">-->
