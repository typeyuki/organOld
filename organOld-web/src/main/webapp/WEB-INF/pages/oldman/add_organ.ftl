                    ...
                    <form method="post" action="/oldman/label/rule/save" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <select class="col-sm-1">
                                <#list info.organType as organType>
                                    <option value="${organType.id!}" name="xq" > <i></i> ${organType.value!}</option>
                                </#list>
                            </select>
                            <label class="col-sm-2 control-label">名称</label>
                            <select class="col-sm-1">
                                <#list info.name as name>
                                    <option value="${name.id!}" name="name" > <i></i> ${name.value!}</option>
                                </#list>
                            </select>
                            <label class="col-sm-2 control-label">简介</label>
                            <select class="col-sm-1">
                                <#list info.intro as intro>
                                    <option value="${intro.id!}" name="name" > <i></i> ${intro.value!}</option>
                                </#list>
                            </select>
