...
<script type="text/javascript">
    ...
    $(".oldman_tu").css('width',oldman_tu_w);
...
<script>
    ...
    var oldman_option_family_pie = chartPie(title_text,legend_data,series);
    ...
    var oldman_option_health_pie = chartPie(title_text,legend_data,series);
    ...
    var oldman_option_econmic_pie = chartPie(title_text,legend_data,series);
