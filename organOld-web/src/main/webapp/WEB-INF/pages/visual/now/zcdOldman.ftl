...
<div id="child_zcdOldman" style="display: none">
    <div class="row box">
        <div class="zz"></div>
        <p class="title" onclick="change('child_zcdOldman','child_organ')">养老院床位数总和</p>
        <div class="col-lg-3">
...
<script type="text/javascript">
    ...
    if(winWidth>=1900){
        ...
        zcdOldman_tu_h=winHeight/10.05;
...
<script>
    ...
    var zcdOldman_option_1_wl = chartPie(title_text,legend_data,series);
    title_text="";
    legend_data=[{name:'已入住',textStyle:{color:legend_color,fontSize:18}},{name:'剩余',textStyle:{color:legend_color,fontSize:18}}];
    series=[{
        name: '老人户籍',
    ...
    var zcdOldman_option_2_wl = chartPie(title_text,legend_data,series);
    title_text="";
    legend_data=[{name:'已入住',textStyle:{color:legend_color,fontSize:18}},{name:'剩余',textStyle:{color:legend_color,fontSize:18}}];
    series=[{
        name: '老人户籍',
    ...
    var zcdOldman_option_3_wl = chartPie(title_text,legend_data,series);
